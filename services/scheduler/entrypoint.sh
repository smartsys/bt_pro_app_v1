...
# GEÄNDERT (Ticket 86): cron startet seine Jobs mit einer minimalen Eigen-Umgebung und
...
# Container als uid 1000 (Ticket 81); eine root-eigene Datei in einem geteilten Mount
